...
<div class="content">
	<!--Begin Edit Modañ--> 
 <div class="modal fade " id="ShowPatrimonial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                    
                    <button type="button" class="close" data-dismiss="modal">×</button>
                    <h3 ng-hide="newUser">Modificar Patrimonio</h3>
            ...
            <!--                                         <h4 for="fol">INFORMACIÓN TURÍSTICA</h4> -->
                                                    ...
                                                    <div class="col-12 mb-3 col-md-12">
                                                        ...
                                                        <!-- <input type="text" value="MALO" id="rapi" name="rapi"> -->
                                                        <!-- <div id="rapi" >ESTADO API</div> -->
                                                        <input type="text" value="" id="srapi" name="srapi">
...
//}
           ...
           <script type="text/javascript">
            ...
            $(function(){
                ...
                alert(type_idc);
                totalSumado = totalSumado + parseInt(type_idc);
                }
                    ...
                    if(totalSumado<=5){
                    document.getElementById('srapi').innerHTML = 'SI ';
                    }else{
                        if(totalSumado>=6 && totalSumado<=7){
                            document.getElementById('srapi').innerHTML = 'LIMITADA ';
                        }else {
                            document.getElementById('srapi').innerHTML = 'NO E';
                        }
                    }
                }
                var totalSumadoca = 0;
                var sum =0;
                    ...
                    for( i=0; i<totalChecks4; i++){
                        if( obj[i].checked == true ){
                            valor1 = obj[i].value.split('-');
                            totalSumadoca = totalSumadoca + parseInt(valor1[0],10);
                        }
                    }
